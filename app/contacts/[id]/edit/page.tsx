...
export default function EditContactPage() {
    ...
    async function loadContact() {
      try {
        ...
        setFormData({
          ...
          savings_investments: data.savings_investments?.toString() || "",
          mortgage_value: data.mortgage_value?.toString() || "",
          supervising_financial_advisor: data.supervising_financial_advisor || "",
          supporting_broker: data.supporting_broker || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await contactService.update(params.id as string, updateData)
      window.location.href =  `/contacts/${params.id}`
    } catch (error) {
