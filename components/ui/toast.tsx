...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-[.destructive]:text-white group-[.destructive]:hover:bg-red-700",
      "group-[.success]:text-white group-[.success]:hover:bg-green-700",
      "group-[.warning]:text-black group-[.warning]:hover:bg-yellow-600",
      "group-[.info]:text-white group-[.info]:hover:bg-blue-700",
